 ...
 *
 */
package com.masmiths.greg.knime;
 ...
 * @author Greg Smith
 */
public class NodeFrameworkPluginNodePlugin extends Plugin {
    // The shared instance.
    private static NodeFrameworkPluginNodePlugin plugin;

    /**
     * The constructor.
     */
    public NodeFrameworkPluginNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static NodeFrameworkPluginNodePlugin getDefault() {
        return plugin;
    }
